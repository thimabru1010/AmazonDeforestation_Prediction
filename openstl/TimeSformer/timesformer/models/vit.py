...
from openstl.TimeSformer.timesformer.models.vit_utils import IMAGENET_DEFAULT_MEAN, IMAGENET_DEFAULT_STD
from openstl.TimeSformer.timesformer.models.helpers import load_pretrained
from openstl.TimeSformer.timesformer.models.vit_utils import DropPath, to_2tuple, trunc_normal_
        ...
        self.model = VisionTransformer(img_size=img_size, num_classes=num_classes, patch_size=patch_size,\
            embed_dim=768, depth=depth, num_heads=12, mlp_ratio=4, qkv_bias=True,\
                norm_layer=partial(nn.LayerNorm, eps=1e-6), drop_rate=0., attn_drop_rate=0., drop_path_rate=0.1,\
                    num_frames=num_frames, attention_type=attention_type, in_chans=32, **kwargs)
