...
train_set = CustomDataset(root_dir=root_dir / 'Train')
val_set = CustomDataset(root_dir=root_dir / 'Val')
test_set = CustomDataset(root_dir=root_dir / 'Test')
...
custom_training_config = {
    ...
    'dataname': 'custom',
    'in_shape': [4, 3, 256, 256], # T, C, H, W = self.args.in_shape
}
